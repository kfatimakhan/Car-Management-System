...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Rental</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.rentals.update', $rental) }}" method="POST">
                ...
                <div class="form-group">
                    <div id="rental-summary" class="alert alert-info">
                        <h6 class="font-weight-bold">Rental Summary</h6>
                        <p>Total Days: <span id="total-days">{{ $rental->start_date->diffInDays($rental->end_date) + 1 }}</span></p>
                        <p>Daily Rate: $<span id="daily-rate">{{ number_format($rental->car->daily_rent_price, 2) }}</span></p>
                        <p>Total Cost: $<span id="total-cost">{{ number_format($rental->total_cost, 2) }}</span></p>
                    </div>
                </div>
